...
All the environments are registered in the `quadruped_parkour` extension. They start
...
import quadruped_parkour.tasks  # noqa: F401


def main():
    """Print all environments registered in `quadruped_parkour` extension."""
